...
// ignore: unused_element
  Authenticated authenticated({@required AUser user}) {
...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object>({
    ...
    @required TResult authenticated(AUser user),
    @required TResult unauthenticated(),
  });
  @optionalTypeArgs
  TResult maybeWhen<TResult extends Object>({
    TResult initial(),
    TResult authenticated(AUser user),
...
class _$AuthenticatedCopyWithImpl<$Res> extends _$AuthStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(Authenticated(
      user: user == freezed ? _value.user : user as AUser,
    ));
  }
  ...
  $AUserCopyWith<$Res> get user {
    ...
    return $AUserCopyWith<$Res>(_value.user, (value) {
...
abstract class Authenticated implements AuthState {
  const factory Authenticated({@required AUser user}) = _$Authenticated;
